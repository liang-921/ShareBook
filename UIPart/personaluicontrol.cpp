...
void PersonalUIControl::initData()
{
    ...
    interest_json1.insert("signal","个签001");
    interest_json1.insert("file","PersonalPage.qml");
    QJsonObject interest_json2;
    interest_json2.insert("nickName","Susan");
    interest_json2.insert("signal","个签002");
    interest_json2.insert("file","PersonalPage.qml");
    QJsonObject interest_json3;
    interest_json3.insert("nickName","Mark");
    interest_json3.insert("signal","个签003");
    interest_json3.insert("file","PersonalPage.qml");
    QJsonArray interest;
    ...
    fan_json1.insert("signal","个签004");
    fan_json1.insert("file","PersonalPage.qml");
    QJsonObject fan_json2;
    fan_json2.insert("nickName","Joey");
    fan_json2.insert("signal","个签005");
    fan_json2.insert("file","PersonalPage.qml");
    QJsonObject fan_json3;
    fan_json3.insert("nickName","Lay");
    fan_json3.insert("signal","个签006");
    fan_json3.insert("file","PersonalPage.qml");
    QJsonArray fans;
